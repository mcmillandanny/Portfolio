        ...
        function e(t, n, r) {
                ...
                AnimatedParticle.prototype.update = function (delta) {
                    ...
                    if (lerp >= 0) {
                        ...
                        if (this.elapsed > this.duration) {
                            ...
                            if (this.loop) this.elapsed = this.elapsed % this.duration;else this.elapsed = this.duration - 0.000001;
                        }
                ...
                AnimatedParticle.parseArt = function (art) {
                    ...
                    for (var i = 0; i < art.length; ++i) {
                        ...
                        for (var j = 0; j < textures.length; ++j) {
                            tex = textures[j];
                            if (typeof tex == "string") outTextures.push(Texture.fromImage(tex));else if (tex instanceof Texture) outTextures.push(tex);else {
                                var dupe = tex.count || 1;
                                if (typeof tex.texture == "string") tex = Texture.fromImage(tex.texture);else tex = tex.texture;
                                for (; dupe > 0; --dupe) {
            ...
            var Emitter = /** @class */function () {
                ...
                Emitter.prototype.init = function (art, config) {
                    ...
                    } else this.startAlpha = new PropertyNode_1.default(1, 0);
                    //set up the speed
                    if (config.speed) {
                    ...
                    if (config.ease) {
                        this.customEase = typeof config.ease == "function" ? config.ease : ParticleUtils_1.default.generateEase(config.ease);
                ...
                Emitter.prototype._spawnRect = function (p, emitPosX, emitPosY) {
                    ...
                    if (this.rotation !== 0) ParticleUtils_1.default.rotatePoint(this.rotation, helperPoint);
            ...
            var Particle = /** @class */function (_super) {
                ...
                Particle.parseArt = function (art) {
                    ...
                    for (i = art.length; i >= 0; --i) {
                        if (typeof art[i] == "string") art[i] = PIXI.Texture.fromImage(art[i]);
                    }
            ...
            var ParticleUtils = {
                 ...
                 * @static
                 */
                rotatePoint: function rotatePoint(angle, p) {
                    if (!angle) return;
                 ...
                 * @static
                 */
                combineRGBComponents: function combineRGBComponents(r, g, b /*, a*/) {
                 ...
                 */
                scaleBy: function scaleBy(point, value) {
                    point.x *= value;
                    point.y *= value;
                },
                /**
                 ...
                 * @static
                 */
                hexToRGB: function hexToRGB(color, output) {
                    if (!output) output = {};
                 ...
                 * @static
                 */
                generateEase: function generateEase(segments) {
                 ...
                 * @static
                 */
                getBlendMode: function getBlendMode(name) {
                 ...
                 * @static
                 */
                createSteppedGradient: function createSteppedGradient(list, numSteps) {
                    if (numSteps === void 0) {
                        numSteps = 10;
                    }
                ...
                PathParticle.parseData = function (extraData) {
                    ...
                    if (extraData && extraData.path) {
                        try {
                            ...
                            if (ParticleUtils_1.default.verbose) console.error("PathParticle: error in parsing path expression");
                            output.path = null;
                        }
                    } else {
                        if (ParticleUtils_1.default.verbose) console.error("PathParticle requires a path string in extraData!");
                        output.path = null;
                    }
                    return output;
                };
            ...
            var PropertyNode = /** @class */function () {
                ...
                PropertyNode.createList = function (data) {
                    if (Array.isArray(data.list)) {
                        ...
                        if (data.end !== data.start) start.next = new PropertyNode(data.end, 1);
                        return start;
                    }
                };
                return PropertyNode;
